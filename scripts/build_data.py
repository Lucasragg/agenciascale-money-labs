...
CAMPAIGN_VIEWS = {
    ...
    "Gabi": ("gabi | e2-cap", "gabi | es | pur", "gabriela | es | leads", "gabriela | es | purchase"),
    "Nick": ("nick | en | leads",),
}
